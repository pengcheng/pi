...
class PTMsg:
  ...
  def decode40(self):
    ...
    ret['pm1.0']        = self.data[4] * 256 +  self.data[5]
    ret['pm2.5']        = self.data[6] * 256 +  self.data[7]
    ret['pm10']         = self.data[8] * 256 +  self.data[9]
    ret['pm1.0_air']    = self.data[10] * 256 + self.data[11]
    ret['pm2.5_air']    = self.data[12] * 256 + self.data[13]
    ret['pm10_air']     = self.data[14] * 256 + self.data[15]
    ret['cnt_0.3']      = self.data[16] * 256 + self.data[17]
    ret['cnt_0.5']      = self.data[18] * 256 + self.data[19]
    ret['cnt_1.0']      = self.data[20] * 256 + self.data[21]
    ret['cnt_2.5']      = self.data[22] * 256 + self.data[23]
    ret['cnt_5.0']      = self.data[24] * 256 + self.data[25]
    ret['cnt_1.0']      = self.data[26] * 256 + self.data[27]
